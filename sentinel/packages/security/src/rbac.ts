...
export const API_PERMISSIONS: EndpointPermission[] = [
  ...
  // Compliance Wizards
  { method: "POST", path: "/v1/compliance/wizards", roles: ["admin", "manager"] },
  { method: "GET", path: "/v1/compliance/wizards", roles: ["admin", "manager", "developer", "viewer"] },
  { method: "GET", path: "/v1/compliance/wizards/:wizardId", roles: ["admin", "manager", "developer", "viewer"] },
  { method: "DELETE", path: "/v1/compliance/wizards/:wizardId", roles: ["admin"] },
  { method: "PATCH", path: "/v1/compliance/wizards/:wizardId", roles: ["admin", "manager"] },
  { method: "GET", path: "/v1/compliance/wizards/:wizardId/steps/:code", roles: ["admin", "manager", "developer", "viewer"] },
  { method: "PATCH", path: "/v1/compliance/wizards/:wizardId/steps/:code", roles: ["admin", "manager", "developer"] },
  { method: "POST", path: "/v1/compliance/wizards/:wizardId/steps/:code/complete", roles: ["admin", "manager"] },
  { method: "POST", path: "/v1/compliance/wizards/:wizardId/steps/:code/skip", roles: ["admin", "manager"] },
  { method: "POST", path: "/v1/compliance/wizards/:wizardId/steps/:code/evidence", roles: ["admin", "manager", "developer"] },
