...
import type {
  Attestation,
  AttestationOverride,
} from "@/components/compliance/attestation-types";
...
export const MOCK_ATTESTATIONS: Attestation[] = [
  {
    ...
    description: "Annual review of logical access controls confirms all production systems require MFA and role-based access. Privileged access reviewed quarterly.",
    score: 0.95,
    status: "approved",
    scanId: null,
    certificateId: null,
    snapshot: {
      ...
      scanRiskScore: 12,
      capturedAt: "2026-02-15T10:30:00Z",
    },
    version: 1,
    validFrom: "2026-02-15T10:30:00Z",
    validUntil: null,
    ...
    approvals: [
      { id: "appr-001", attestationId: "att-001", stage: "review", decision: "approved", comment: "Looks thorough", decidedBy: "bob@acme.com", decidedAt: "2026-02-15T14:20:00Z", createdAt: "2026-02-15T10:31:00Z" },
      { id: "appr-002", attestationId: "att-001", stage: "final_approval", decision: "approved", comment: "Approved for Q1", decidedBy: "admin@acme.com", decidedAt: "2026-02-16T14:20:00Z", createdAt: "2026-02-15T14:21:00Z" },
    ],
    evidence: [
      { id: "ev-001", attestationId: "att-001", type: "url", title: "Confluence DR Plan", refId: null, url: "https://acme.atlassian.net/wiki/dr-plan", source: "confluence", metadata: {}, createdAt: "2026-02-15T10:30:00Z" },
      { id: "ev-002", attestationId: "att-001", type: "ticket", title: "JIRA-1234 Annual pentest report", refId: "JIRA-1234", url: null, source: "jira", metadata: {}, createdAt: "2026-02-15T10:30:00Z" },
      { id: "ev-003", attestationId: "att-001", type: "snapshot", title: "Auto-Snapshot at 2026-02-15T10:30:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-02-15T10:30:00Z" },
    ],
  },
  {
    id: "att-002",
    ...
    frameworkSlug: "slsa",
    controlCode: "SL4",
    title: "Build Provenance Verification",
    description: "Scan results for SLSA Build Provenance have been reviewed and approved. All build artifacts have verifiable provenance.",
    score: 0.90,
    status: "approved",
    scanId: "scan-101",
    certificateId: "cert-301",
    ...
    approvals: [
      { id: "appr-003", attestationId: "att-002", stage: "review", decision: "approved", comment: "Build pipeline verified", decidedBy: "jane@acme.com", decidedAt: "2026-03-01T15:00:00Z", createdAt: "2026-03-01T09:01:00Z" },
      { id: "appr-004", attestationId: "att-002", stage: "final_approval", decision: "approved", comment: null, decidedBy: "admin@acme.com", decidedAt: "2026-03-02T11:00:00Z", createdAt: "2026-03-01T15:01:00Z" },
    ],
    evidence: [
      { id: "ev-004", attestationId: "att-002", type: "scan", title: "Scan scan-101 results", refId: "scan-101", url: null, source: "internal", metadata: {}, createdAt: "2026-03-01T09:00:00Z" },
      { id: "ev-005", attestationId: "att-002", type: "snapshot", title: "Auto-Snapshot at 2026-03-01T09:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-01T09:00:00Z" },
    ],
  },
  {
    id: "att-003",
    ...
    controlCode: "A.7",
    title: "Human Resource Security Review",
    description: "Security awareness training program updated and all employees completed annual training. Background checks current for all staff.",
    score: 0.88,
    ...
    approvals: [
      { id: "appr-005", attestationId: "att-003", stage: "review", decision: "pending", comment: null, decidedBy: null, decidedAt: null, createdAt: "2026-03-10T08:01:00Z" },
    ],
    evidence: [
      { id: "ev-006", attestationId: "att-003", type: "document", title: "Training completion report 2026", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-10T08:00:00Z" },
      { id: "ev-007", attestationId: "att-003", type: "snapshot", title: "Auto-Snapshot at 2026-03-10T08:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-10T08:00:00Z" },
    ],
  },
  {
    id: "att-004",
    ...
    description: "Automated scan results approved. All changes go through PR review, CI/CD pipeline, and staging validation.",
    score: 0.92,
    ...
    approvals: [
      { id: "appr-006", attestationId: "att-004", stage: "review", decision: "approved", comment: "LGTM", decidedBy: "jane@acme.com", decidedAt: "2026-03-13T09:00:00Z", createdAt: "2026-03-12T10:01:00Z" },
      { id: "appr-007", attestationId: "att-004", stage: "final_approval", decision: "pending", comment: null, decidedBy: null, decidedAt: null, createdAt: "2026-03-13T09:01:00Z" },
    ],
    evidence: [
      { id: "ev-008", attestationId: "att-004", type: "scan", title: "Scan scan-104 results", refId: "scan-104", url: null, source: "internal", metadata: {}, createdAt: "2026-03-12T10:00:00Z" },
      { id: "ev-009", attestationId: "att-004", type: "snapshot", title: "Auto-Snapshot at 2026-03-12T10:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-12T10:00:00Z" },
    ],
  },
  {
    id: "att-005",
    ...
    description: "Breach notification procedure was reviewed but found insufficient. Missing 72-hour timeline documentation.",
    score: 0.70,
    status: "rejected",
    scanId: null,
    certificateId: null,
    snapshot: {
      ...
      certificateStatus: null,
      scanRiskScore: null,
      capturedAt: "2026-03-05T14:00:00Z",
    },
    version: 1,
    validFrom: "2026-03-05T14:00:00Z",
    validUntil: null,
    expiresAt: "2027-03-05T14:00:00Z",
    supersededById: null,
    createdBy: "jane@acme.com",
    createdAt: "2026-03-05T14:00:00Z",
    updatedAt: "2026-03-06T10:00:00Z",
    approvals: [
      { id: "appr-008", attestationId: "att-005", stage: "review", decision: "rejected", comment: "Missing 72-hour timeline documentation. Please update the procedure and resubmit.", decidedBy: "bob@acme.com", decidedAt: "2026-03-06T10:00:00Z", createdAt: "2026-03-05T14:01:00Z" },
    ],
    evidence: [
      { id: "ev-010", attestationId: "att-005", type: "document", title: "Breach notification procedure v1", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-05T14:00:00Z" },
      { id: "ev-011", attestationId: "att-005", type: "snapshot", title: "Auto-Snapshot at 2026-03-05T14:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-05T14:00:00Z" },
    ],
  },
  {
    id: "att-006",
    ...
    description: "Physical security assessment completed for the main data center. All access points secured.",
    score: 0.85,
    status: "expired",
    scanId: null,
    certificateId: null,
    ...
    approvals: [
      { id: "appr-009", attestationId: "att-006", stage: "review", decision: "approved", comment: null, decidedBy: "jane@acme.com", decidedAt: "2025-09-02T10:00:00Z", createdAt: "2025-09-01T10:01:00Z" },
      { id: "appr-010", attestationId: "att-006", stage: "final_approval", decision: "approved", comment: "Approved", decidedBy: "admin@acme.com", decidedAt: "2025-09-03T11:00:00Z", createdAt: "2025-09-02T10:01:00Z" },
    ],
    evidence: [
      { id: "ev-012", attestationId: "att-006", type: "url", title: "Security assessment report", refId: null, url: "https://acme.atlassian.net/wiki/physical-sec", source: "confluence", metadata: {}, createdAt: "2025-09-01T10:00:00Z" },
      { id: "ev-013", attestationId: "att-006", type: "snapshot", title: "Auto-Snapshot at 2025-09-01T10:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2025-09-01T10:00:00Z" },
    ],
  },
  {
    id: "att-007",
    ...
    description: "Draft risk assessment update for Q1 2026. Pending internal review before submission.",
    score: 0.80,
    status: "draft",
    scanId: null,
    certificateId: null,
    snapshot: {
      ...
      certificateStatus: null,
      scanRiskScore: null,
      capturedAt: "2026-03-14T16:00:00Z",
    },
    version: 1,
    validFrom: "2026-03-14T16:00:00Z",
    validUntil: null,
    ...
    approvals: [],
    evidence: [
      { id: "ev-014", attestationId: "att-007", type: "snapshot", title: "Auto-Snapshot at 2026-03-14T16:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2026-03-14T16:00:00Z" },
    ],
  },
  {
    id: "att-008",
    ...
    frameworkSlug: "soc2",
    controlCode: "CC6.1",
    title: "Logical Access Controls (superseded)",
    description: "Previous version of logical access controls attestation.",
    score: 0.85,
    status: "superseded",
    scanId: null,
    certificateId: null,
    ...
    validUntil: "2026-02-15T10:30:00Z",
    expiresAt: "2026-02-15T10:00:00Z",
    supersededById: "att-001",
    createdBy: "jane@acme.com",
    createdAt: "2025-11-15T10:00:00Z",
    updatedAt: "2026-02-15T10:30:00Z",
    approvals: [
      { id: "appr-011", attestationId: "att-008", stage: "review", decision: "approved", comment: null, decidedBy: "bob@acme.com", decidedAt: "2025-11-16T10:00:00Z", createdAt: "2025-11-15T10:01:00Z" },
      { id: "appr-012", attestationId: "att-008", stage: "final_approval", decision: "approved", comment: null, decidedBy: "admin@acme.com", decidedAt: "2025-11-17T10:00:00Z", createdAt: "2025-11-16T10:01:00Z" },
    ],
    evidence: [
      { id: "ev-015", attestationId: "att-008", type: "snapshot", title: "Auto-Snapshot at 2025-11-15T10:00:00Z", refId: null, url: null, source: "internal", metadata: {}, createdAt: "2025-11-15T10:00:00Z" },
    ],
  },
];

export const MOCK_ATTESTATION_OVERRIDES: AttestationOverride[] = [
  { frameworkSlug: "soc2", controlCode: "CC6.1", score: 0.95, attestationId: "att-001", expiresAt: "2026-05-15T10:30:00Z" },
  { frameworkSlug: "slsa", controlCode: "SL4", score: 0.90, attestationId: "att-002", expiresAt: "2026-05-30T09:00:00Z" },
];
