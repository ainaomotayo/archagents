...
interface VelocityChartProps {
  initialData: VelocityDataPoint[];
  onRefresh: (scope: string, scopeValue: string, days: number) => Promise<VelocityDataPoint[]>;
}
...
export function VelocityChart({ initialData, onRefresh }: VelocityChartProps) {
  ...
  return (
    <div className="rounded-xl border border-border bg-surface-1 p-5">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-[14px] font-semibold text-text-primary">Velocity</h3>
