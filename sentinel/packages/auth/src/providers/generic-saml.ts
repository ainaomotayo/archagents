...
const SAML_EMAIL_CLAIM =
  "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress";

export class GenericSamlProvider implements SsoProvider {
  readonly id = "generic-saml" as const;
  readonly protocol = "saml" as const;
  readonly displayName = "Generic SAML";
  ...
  mapClaims(profile: Record<string, unknown>): StandardClaims {
    ...
    const email =
      ...
      (profile[SAML_EMAIL_CLAIM] as string) ??
      "";
    const name =
