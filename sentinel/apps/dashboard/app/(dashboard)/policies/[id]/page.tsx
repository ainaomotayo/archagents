...
export default function PolicyEditorPage({
  ...
  // Detect format: check for treeRules on the policy object
  const policyAny = existing as any;
  const detectedFormat: "tree" | "yaml" =
    policyAny?.format === "tree" || policyAny?.treeRules ? "tree" : "yaml";
  const initialTreeRules: GroupNode | undefined = policyAny?.treeRules ?? undefined;
  ...
  }, [detectedFormat, messages, isNew, policyName, resolvedParams.id, router]);
